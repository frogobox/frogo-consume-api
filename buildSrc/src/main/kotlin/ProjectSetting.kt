...
object ProjectSetting {
    ...
    @Deprecated("Use BASE_PACKAGE_NAME instead", ReplaceWith("BASE_PACKAGE_NAME"))
    const val BASE_PACAKGE_NAME = BASE_PACKAGE_NAME

    const val PROJECT_APP_ID = "$BASE_PACKAGE_NAME.$APP_NAME"

    const val PROJECT_LIB_ID_API = "$BASE_PACKAGE_NAME.$LIBRARY_NAME_API"
    const val PROJECT_LIB_ID_CORE_API = "$BASE_PACKAGE_NAME.$LIBRARY_NAME_CORE_API"
    const val PROJECT_LIB_ID_CORE_UTIL = "$BASE_PACKAGE_NAME.$LIBRARY_NAME_CORE_UTIL"
