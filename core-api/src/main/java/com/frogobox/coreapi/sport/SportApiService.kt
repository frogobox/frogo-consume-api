...
interface SportApiService {
    ...
    ): Call<com.frogobox.coreutil.sport.response.Teams>
    ...
    fun searchForAllPlayer(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String,
        @Query(com.frogobox.coreutil.sport.SportConstant.QUERY_TEAM_NAME) teamName: String?
    ): Call<com.frogobox.coreutil.sport.response.Players>
    ...
    ): Call<com.frogobox.coreutil.sport.response.Events>
    ...
    fun getAllSports(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String
    ): Call<com.frogobox.coreutil.sport.response.Sports>

    // List all leagues
    @GET(com.frogobox.coreutil.sport.SportUrl.GET_ALL_LEAGUES)
    fun getAllLeagues(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String
    ): Call<com.frogobox.coreutil.sport.response.Leagues>
    ...
    ): Call<com.frogobox.coreutil.sport.response.Countrys>
    ...
    ): Call<com.frogobox.coreutil.sport.response.Seasons>
    ...
    ): Call<com.frogobox.coreutil.sport.response.Users>
    ...
    fun lookupHonour(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String,
        @Query(com.frogobox.coreutil.sport.SportConstant.QUERY_ID) idPlayer: String?
    ): Call<com.frogobox.coreutil.sport.response.Honors>
    ...
    fun lookupFormerTeam(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String,
        @Query(com.frogobox.coreutil.sport.SportConstant.QUERY_ID) idPlayer: String?
    ): Call<com.frogobox.coreutil.sport.response.FormerTeams>
    ...
    fun lookupContract(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String,
        @Query(com.frogobox.coreutil.sport.SportConstant.QUERY_ID) idPlayer: String?
    ): Call<com.frogobox.coreutil.sport.response.Contracts>
    ...
    fun lookupTable(
        ...
        @Query(com.frogobox.coreutil.sport.SportConstant.QUERY_SEASON) season: String?
    ): Call<com.frogobox.coreutil.sport.response.Tables>
    ...
    fun eventsLast(
        @Path(com.frogobox.coreutil.sport.SportConstant.PATH_API_KEY) apiKey: String,
        @Query(com.frogobox.coreutil.sport.SportConstant.QUERY_ID) idTeam: String?
    ): Call<com.frogobox.coreutil.sport.response.Results>
