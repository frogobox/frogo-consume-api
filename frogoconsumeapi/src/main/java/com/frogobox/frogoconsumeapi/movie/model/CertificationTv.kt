...
data class CertificationTv(
    ...
    @SerializedName("TH")
    var TH: List<com.frogobox.frogoconsumeapi.movie.model.Certification>? = null,

    @SerializedName("KR")
    var KR: List<com.frogobox.frogoconsumeapi.movie.model.Certification>? = null,
    ...
    @SerializedName("SK")
    var SK: List<com.frogobox.frogoconsumeapi.movie.model.Certification>? = null
