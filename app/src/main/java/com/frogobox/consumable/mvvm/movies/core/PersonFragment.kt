...
import com.frogobox.consumable.mvvm.movies.person.PersonDayFragment
import com.frogobox.consumable.mvvm.movies.person.PersonWeekFragment
 ...
 */
class PersonFragment : FrogoBaseFragment<FragmentTrendingBinding>() {
